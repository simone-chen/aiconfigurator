...
class TestMoE:
    ...
    def test_query_moe_sol_mode(self, comprehensive_perf_db):
        ...
        result = comprehensive_perf_db.query_moe(
            ...
            moe_tp_size, moe_ep_size, quant_mode, workload_distribution,
        ...
        sol_math = ops / (comprehensive_perf_db.system_spec['gpu']['float16_tc_flops'] * quant_mode.value.compute) * 1000
    ...
    def test_query_moe_sol_full_mode(self, comprehensive_perf_db):
        ...
        result = comprehensive_perf_db.query_moe(
            8, 1024, 4096, 2, 8, 1, 1,
            common.MoEQuantMode.float16, 'uniform',
    ...
    def test_query_moe_non_sol_mode(self, comprehensive_perf_db):
        ...
        expected = comprehensive_perf_db._moe_data[quant_mode][workload_distribution][topk][num_experts][hidden_size][inter_size][moe_tp_size][moe_ep_size][num_tokens]
        assert math.isclose(result, expected, rel_tol=1e-6)
...
class TestMLABMM:
    ...
    def test_query_mla_bmm_sol_mode_pre(self, comprehensive_perf_db):
        ...
        result = comprehensive_perf_db.query_mla_bmm(
            num_tokens, num_heads, quant_mode, if_pre,
            sol_mode=common.SOLMode.SOL
        )
    ...
    def test_query_mla_bmm_sol_full_mode(self, comprehensive_perf_db):
        """Test SOL_FULL mode returns complete tuple."""
        result = comprehensive_perf_db.query_mla_bmm(
            8, 4, common.GEMMQuantMode.float16, True,
            sol_mode=common.SOLMode.SOL_FULL
        )
    ...
    def test_query_mla_bmm_non_sol_mode_pre(self, comprehensive_perf_db):
        ...
        result = comprehensive_perf_db.query_mla_bmm(
            num_tokens, num_heads, quant_mode, True,
            sol_mode=common.SOLMode.NON_SOL
        )
    ...
    def test_query_mla_bmm_non_sol_mode_post(self, comprehensive_perf_db):
        ...
        result = comprehensive_perf_db.query_mla_bmm(
            num_tokens, num_heads, quant_mode, False,
            sol_mode=common.SOLMode.NON_SOL
        )
    ...
    def test_query_mla_bmm_different_configs(self, comprehensive_perf_db):
        ...
        for num_tokens, num_heads, quant_mode, if_pre in configs:
            ...
            assert result > 0, f"Failed for config: tokens={num_tokens}, heads={num_heads}, quant={quant_mode}, pre={if_pre}"
